    ...
    <main className="flex-1 bg-black px-6 py-10 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mb-8 max-w-2xl text-white/70">
          Sube un PDF de tu banco. Extraemos el texto en el servidor,
          detectamos transacciones recurrentes y marcamos cargos sospechosos u
          olvidados. Sin enviar el PDF binario a OpenAI.
        </p>
        ...
        {busy ? (
          <p className="mt-6 animate-pulse text-sm text-emerald-200/90">
            Extrayendo texto y analizando suscripciones…
          </p>
        ) : null}
          ...
          <div className="mt-10 space-y-10">
            ...
            <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <SummaryCard
                ...
                value={formatMoney(data.summary.monthlySpend, "USD")}
              />
              <SummaryCard
                title="Gasto anual est."
                value={formatMoney(data.summary.annualSpend, "USD")}
              />
              <SummaryCard
                title="Suscripciones"
              ...
              <SummaryCard
                ...
                value={formatMoney(data.summary.estimatedSavings, "USD")}
              />
            </section>
            ...
            <section className="space-y-4">
              ...
              {data.subscriptions.length === 0 ? (
                <p className="rounded-xl border border-white/10 bg-white/5 px-4 py-6 text-sm text-white/60">
                  No encontramos patrones recurrentes claros. Prueba un PDF con
                  líneas de fecha + descripción + importe, o un estado más
                  reciente.
                </p>
              ) : (
